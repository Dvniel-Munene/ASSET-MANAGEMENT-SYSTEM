      ...
      <div class="panel-heading clearfix">
        <div class="pull-left">
          <strong>
            ...
            <span>AUDIO EQUIPMENT ASSETS</span>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            // Query to get assets where eq_cat is Audio Equipment
            $sql = "SELECT id, file, eq_code, eq_name, eq_brand, eq_model, serial_no, cost, purchase_location, receipt_no, quantity, accessories, eq_status, created FROM equipment WHERE eq_cat = 'Network Equipment'";
            ...
            if ($result && $result->num_rows > 0) {
              ...
              while ($row = $result->fetch_assoc()) {
                ...
                if (file_exists($imagePath) && !empty($row['file'])) {
                  echo "<td><img src='" . $imagePath . "' alt='' class='img-responsive' style='height: 60px; width: 80px;'></td>";
                } else {
                ...
                if ($row['eq_status'] == 'Operational') {
                  ...
                  echo "<td><span class='badge badge-warning' style='background-color: gray;'>Unknown</span></td>";
                }
