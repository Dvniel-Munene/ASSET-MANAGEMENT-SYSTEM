      ...
      <div class="panel-heading clearfix">
        <div class="pull-left">
          <strong>
            ...
            <span>VISUAL EQUIPMENT ASSETS</span>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          ...
          <tbody>
            ...
            $sql = "SELECT id, file, eq_code, eq_name, eq_brand, eq_model, serial_no, cost, purchase_location, receipt_no, quantity, accessories, eq_status, created FROM equipment WHERE eq_cat = 'Visual Equipment'";
